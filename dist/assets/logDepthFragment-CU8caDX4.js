import{S as e}from"./index-gCZdN4BF.js";const o="lightFragmentDeclaration",f=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=f);const t="lightUboDeclaration",c=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=c);const i="imageProcessingDeclaration",h=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=h);const a="imageProcessingFunctions",v=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=v);const r="shadowsFragmentFunctions",u=`#ifdef SHADOWS
...
#endif
result.Diffuse=LTCEvaluate( normal,viewDir,position,mat3( 1.0 ),rectCoords );return result;}`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=p);const n="reflectionFunction",S=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=S);const l="lightFragment",m=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=m);const d="logDepthFragment",g=`#ifdef LOGARITHMICDEPTH
gl_FragDepthEXT=log2(vFragmentDepth)*logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=g);
//# sourceMappingURL=logDepthFragment-CU8caDX4.js.map
